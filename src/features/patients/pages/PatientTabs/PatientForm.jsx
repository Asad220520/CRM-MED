  ...
  saving,
    ...
    <div className="overflow-auto max-h-[360px] scrollbar-thin scrollbar-blue flex gap-4">
      <div className="flex flex-col gap-4 w-full">
        ...
        <div>
          <label className="block text-sm mb-1 font-medium">Укажите время</label>
          <input
            type="datetime-local"
            value={formData.appointment_date ? formData.appointment_date.slice(0, 16) : ""}
        ...
        <div>
          <label className="block text-sm mb-1 font-medium">Укажите статус пациента</label>
          <select
